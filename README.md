...
**BugSweep** is an AI-based code review tool that helps developers ensure high-quality and maintainable code. Powered by cutting-edge AI models, **BugSweep** analyzes your code for common errors, bugs, style violations, and best practices. This tool is designed to automate code review processes, saving developers valuable time while improving the overall quality of their code.

While **BugSweep** is powered by the **Gemini API** and model, it is highly customizable, and you can easily switch to any other AI model of your choice.
...
BugSweep leverages artificial intelligence to automatically review code against predefined standards and rules. It provides valuable feedback, identifies potential bugs, and suggests improvements, helping developers write cleaner, more efficient code.
...
- **Automatic Code Review on Commit**: BugSweep automatically reviews your code each time you make a commit, ensuring that code quality is maintained consistently.
...
- **Support for Multiple Languages**: Although it’s optimized for Python, BugSweep can be configured to support other languages.
...
To get started with **BugSweep**, follow the steps below to install dependencies and set up the tool.
...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/M3Sachin/BugSweep.git
   ```
...
Once you've installed **BugSweep**, you're ready to start reviewing your code!
...
While **BugSweep** is configured to use the **Gemini API** by default, you can easily switch to another AI model. Modify the `BugSweep.py` file or the configuration file to specify a different model.
...
You can customize **BugSweep** to match your project’s specific needs by adjusting configuration files.

1. **AI Model Selection**: 
   - By default, **BugSweep** uses the Gemini API model for analysis. However, you can switch to any model by editing the configuration file or the relevant parts of the code where the AI model is set up.
   
2. **Coding Standards**:
   - BugSweep allows you to define your own coding rules and standards. Modify the configuration file to set your own preferences for code style, error detection, and more.
...
To integrate **BugSweep** with your GitHub repository and automate code review processes, you'll need to set up a GitHub App. Follow these steps to configure it:
...
Integrate your GitHub App’s authentication into the **BugSweep** code, where necessary, to interact with GitHub APIs. You can configure the API credentials in your `.env` file.

---

## Testing Locally with ngrok

To test **BugSweep** locally and expose your local server to GitHub for webhook notifications, you can use **ngrok**. This allows you to simulate the environment where GitHub sends webhooks to your local server.
...
We welcome contributions to **BugSweep**! If you'd like to contribute, please follow these steps:
...
- Special thanks to the Gemini API and other AI models that make **BugSweep** possible.
...
<a href="https://www.buymeacoffee.com/M3Sachin" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style="height: 60px !important;width: 217px !important;" ></a>
